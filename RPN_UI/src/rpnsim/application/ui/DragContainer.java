...
public class DragContainer implements Serializable {
	...
	public static final DataFormat DragPlace = 
			new DataFormat("rpnsim.application.rpn.Place.drag");
	
	public static final DataFormat DragTransition = 
			new DataFormat("rpnsim.application.rpn.Transition.drag");
