...
public class MovableNode extends EditableNode{
	...
	public MovableNode(RPN rpn, Node myNode, DataFormat dataformat) {
		super(rpn);
	...
	protected void onLeftClick() {
		...
		if( rpn.scrollArea instanceof SimulatorArea ) {
			buildNodeDragHandlers();
			return;
		}
		...
		case "ARROW": 
			...
			if( currentArrow == null ) {
				...
				currentArrow.myArrow = rpn.addArrow(source.myNode, destination.myNode );
